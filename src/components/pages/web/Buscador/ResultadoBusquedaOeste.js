...
export default function ResultadoBusquedaOeste() {
    ...
    useEffect(() => {
        setData(localStorage.getItem("dataBuscadorOeste"));
    }, [location]);
    ...
    if (listaPostGeneral != null && listaPostGeneral.data != null) {
        ...
        for (let i = 0; i < listBusqueda.length; i++) {
            arregloBusquedaFiltrados.push(
                <>
                    {/* <Link to={`/${posts[i].id}`} > */}
                    <PostOeste pos={i} post={listBusqueda[i]} nombreArreglo={"Cronologico"} />
                    {/* </Link> */}
                </>
            );
        }
                            ...
                            <div className='contenedor-busqueda-gris'>
                                <div className='box-titulos-buscador'>
                                    ...
                                    <p className='subtitulo-buscador'>
                                        ...
                                        artículos para la busqueda “{data != null ? data : ''}”
                                    </p>
                                </div>
                            </div>
