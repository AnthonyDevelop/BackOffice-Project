...
function SeccionTarjetasHorizontales(props) {
  ...
  if (props.dataTarjetaHorizontales != null) {
    for (let i = 0; i < props.dataTarjetaHorizontales.length; i++) {
      arregloTarjetas.push(
        <Link to={props.dataTarjetaHorizontales[i].path} onClick={() => {localStorage.setItem("dataPostNota", JSON.stringify(props.dataTarjetaHorizontales[i]))}} >
          <div className='tarjetaHorizontal' key={props.dataTarjetaHorizontales[i].id} >
            ...
            <div className='box-texto-tarjetas-horizontal'>
              <div className='container-categoria-tarjeta-horizontal'> {props.dataTarjetaHorizontales[i].categorias[0].nombre=="DESTACADO_PPAL" || props.dataTarjetaHorizontales[i].categorias[0].nombre=="DESTACADO_VIEW" ? props.dataTarjetaHorizontales[i].categorias[1].nombre : props.dataTarjetaHorizontales[i].categorias[0].nombre}</div> 
              ...
              <p className='autor-tarjeta-horizontal'>Por {props.dataTarjetaHorizontales[i].redactor.nombre}</p>
            </div>
          </div>
        </Link>
      );
...
export default SeccionTarjetasHorizontales