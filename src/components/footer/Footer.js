            ...
            <div className='container-principal-footer-gris'>
                <div className='subcontainer-footer'>
                    <div className='box-informacion-footer'>
                        ...
                        <div className='footer-seccion-text'>
                            <div className='box-texto-footer'>
                                ...
                                <p className='box-texto-footer-line'>{diaPosteo + " de " + mesPosteo + " de " + anoPosteo}</p>
                            </div>
                            <div>
                    ...
                    <div className='box-redes-footer'>
                        <div className='subbox-redes-footer'>
                            <a href='https://www.facebook.com/eleditorplatense' target="_blank" className='contenedor-redes'><img src='https://res.cloudinary.com/grupo-delsud/image/upload/v1668773764/eleditorNoticias/Vector_1_z54qvh.svg' /></a>
                            <a href='https://www.youtube.com/@ElEditorPlatense' target="_blank" className='contenedor-redes'><img src='https://res.cloudinary.com/grupo-delsud/image/upload/v1668773764/eleditorNoticias/Vector_2_bmoabu.svg' /></a>
                            <a href='https://www.instagram.com/eleditorplatense/?hl=es' target="_blank" className='contenedor-redes'><img src='https://res.cloudinary.com/grupo-delsud/image/upload/v1668773764/eleditorNoticias/Vector_3_mua3hk.svg' /></a>
                            <a href='https://twitter.com/editor_platense' target="_blank" className='contenedor-redes'><img src='https://res.cloudinary.com/grupo-delsud/image/upload/v1668774108/eleditorNoticias/Vector_4_wbkdff.svg' /></a>
                        </div>
